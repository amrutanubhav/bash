...
sed -i -e 's/MONGO_DNSNAME/mongodb.roboshop.internal/' -e 's/REDIS_ENDPOINT/redis.roboshop.internal/' -e 's/CATALOGUE_ENDPOINT/catalogue.roboshop.internal/' -e -e 's/MONGO_DNSNAME/mongodb.roboshop.internal/' /home/$user/$component/systemd.service
